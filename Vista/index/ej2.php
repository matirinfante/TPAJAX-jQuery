    ...
    <div class="container border border-2 rounded-3 mt-2 p-2">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active link-danger" id="anime-tab" data-bs-toggle="tab" data-bs-target="#Anime"
                    type="button" role="tab" aria-controls="anime" aria-selected="true" value="0">Anime</button>
                <button class="nav-link link-danger" id="peliculas-tab" data-bs-toggle="tab" data-bs-target="#Peliculas"
                    type="button" role="tab" aria-controls="peliculas" aria-selected="false" value="1">Peliculas</button>
                <button class="nav-link link-danger" id="series-tab" data-bs-toggle="tab" data-bs-target="#Series"
                    type="button" role="tab" aria-controls="series" aria-selected="false" value="2">Series</button>
            </div>
        </nav>
