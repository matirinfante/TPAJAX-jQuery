...
?>
    ...
    <div class="container-fluid" id="containerEj4">
        <div class="button mt-2">
            <button type="button" class="btn_consig btn btn-outline-warning" value="4" data-bs-toggle="tooltip"
                    data-bs-placement="bottom" title="">Consigna
            </button>
        </div>
            ...
            <div class="col-md-6 offset-md-3">
                <div class="card rounded-2">
                    <div class="card-body">
                        ...
                        <form id="formPersona" name="formPersona" method="post" action="actionUserRegister.php"
                              novalidate>
